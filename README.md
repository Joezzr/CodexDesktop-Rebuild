...
The Windows build pins OpenAI Codex `rust-v0.153.4` by commit and prepares
...
stages the matching 0.153.4 standalone code-mode host, then injects `codex.exe`
