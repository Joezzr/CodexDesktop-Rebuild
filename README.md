...
The Windows build pins OpenAI Codex `rust-v0.151.0-alpha.12` by commit and prepares
...
stages the matching alpha.12 standalone code-mode host, then injects `codex.exe`
...
`out/Codex-win-x64-0.151.0-alpha.12/`.
