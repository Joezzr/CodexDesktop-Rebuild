...
The Windows build pins OpenAI Codex `rust-v0.150.0-alpha.7` by commit and prepares
...
stages the matching alpha.7 standalone code-mode host, then injects `codex.exe`
...
`out/Codex-win-x64-0.150.0-alpha.7/`.
