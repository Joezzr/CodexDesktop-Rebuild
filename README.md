...
The Windows build pins OpenAI Codex `rust-v0.149.0-alpha.4` by commit and prepares
...
stages the matching alpha.4 standalone code-mode host, then injects `codex.exe`
...
`out/Codex-win-x64-0.149.0-alpha.4/`.
