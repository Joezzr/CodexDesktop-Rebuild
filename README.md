...
The Windows build pins OpenAI Codex `rust-v0.149.0-alpha.3` by commit and prepares
...
stages the matching alpha.3 standalone code-mode host, then injects `codex.exe`
...
`out/Codex-win-x64-0.149.0-alpha.3/`.
