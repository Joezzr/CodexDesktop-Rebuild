...
The Windows build pins OpenAI Codex `rust-v0.148.0-alpha.21` by commit and prepares
...
stages the matching alpha.21 standalone code-mode host, then injects `codex.exe`
