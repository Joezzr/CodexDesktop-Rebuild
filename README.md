...
The Windows build pins OpenAI Codex `rust-v0.150.0-alpha.2` by commit and prepares
...
stages the matching alpha.2 standalone code-mode host, then injects `codex.exe`
...
`out/Codex-win-x64-0.150.0-alpha.2/`.
