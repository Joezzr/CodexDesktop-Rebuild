...
const CODEX_VERSION = "0.148.0-alpha.21";
const CODEX_TAG = `rust-v${CODEX_VERSION}`;
const CODEX_TAG_OBJECT = "889e1b2b2fb633c2855909cf252ff8ea165c5f9a";
const CODEX_COMMIT = "fecac1c348af3634924e1a1b5413376208ee1884";
