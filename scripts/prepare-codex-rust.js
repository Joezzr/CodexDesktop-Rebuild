...
const CODEX_VERSION = "0.148.0-alpha.5";
const CODEX_TAG = `rust-v${CODEX_VERSION}`;
const CODEX_TAG_OBJECT = "162cd783906351ecda25364b345b5fb95872fff3";
const CODEX_COMMIT = "f757695017737bb9fcdbc595a101721704205e76";
