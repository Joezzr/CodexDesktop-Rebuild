...
const CODEX_VERSION = "0.150.0-alpha.13";
const CODEX_TAG = `rust-v${CODEX_VERSION}`;
const CODEX_TAG_OBJECT = "8986f792fc8d7e1ff4a020a916ee76e9884f520a";
const CODEX_COMMIT = "c080ad22b3744f3cefcdeeb134ee17c0093d16a1";
